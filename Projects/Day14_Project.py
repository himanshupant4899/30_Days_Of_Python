...
def add_book():
    ...
    with open("books.csv", "a") as books_list:
        books_list.write(f'{title}, {author}, {year},Not Read\n')
...
def get_all_books():
    books = []
    with open("books.csv", "r") as books_list:
...
def display_books(books):
    ...
    for book in books:
        print(
            f'{book["title"]} ({book["year"]}) written by {book["author"]} - {book["read"]}'
        )
    print()
